...
dc = 0.5 ###densidad inicial de conejos. Probabilidad de que una celda empiece con un conejo.
...
def __main__():
    ...
    for turno in range(tmax):
        time.sleep(0.1)
        os.system('cls')
        snapshot = imprimir(matriz, snapshot, turno, muertes_conejos, muertes_zorros)
        ...
        for celda in matriz: # 3. movimiento de los zorros
            ...
            if str(type(celda[1])) == '<class \'dict\'>':
                ...
                if movimiento != None:
                    if celda[1]['tipo'] == 'zorro':
                        if str(type(matriz[movimiento][1])) != '<class \'dict\'>':
        ...
        for celda in matriz: # 4. movimiento de los conejos
            ...
            if str(type(celda[1])) == '<class \'dict\'>':
                ...
                if movimiento != None:
                    if celda[1]['tipo'] == 'conejo':
                        if str(type(matriz[movimiento][1])) != '<class \'dict\'>':
                            if snapshot[movimiento][1] == 'pasto':
                                era_pasto = True
                            else:
                                era_pasto = False
        ...
        for celda in matriz: # 5. reproduccion de los animales
            ...
            if str(type(celda[1])) == '<class \'dict\'>':
                ...
                if celda[1]['tipo'] == 'conejo' and  c1 == True and c2 == True and cc == True: 
                    # si es un conejo, su celda de origen esta vacia y tiene la energia necesaria para reproducirse, se realiza el calculo estadistico
                    matriz[origen][1] = {"tipo":    "conejo", 
                                                  "energia": ec,   # energía actual del animal 
                                                  "edad": 0,    # cantidad de turnos que lleva vivo
                                                  'origen': origen
                                                  }
                elif celda[1]['tipo'] == 'zorro' and c1 == True and c2 == True and cz == True: 
                    # si es un zorro, su celda de origen esta vacia y tiene la energia necesaria para reproducirse, se realiza el calculo estadistico
